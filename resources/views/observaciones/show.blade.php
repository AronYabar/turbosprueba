    ...
    <body>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td width="15%"  align="right"style="font-size:x-large;color:#002699;"><strong>ORDEN</strong></td>
        ...
        <main>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    @if(isset($ser->adelanto)==true)
                        <td style="font-size:12px;"align="right"><strong>ANTICIPO S/.</strong></td>
                        <td style="font-size:12px;color:#474747;">{{sprintf("%.2f",@$ser->adelanto)}}</td>
                        <td style="font-size:12px;"align="right"><strong>SALDO S/.</strong></td>
                        <td style="font-size:12px;color:#474747;">{{sprintf("%.2f",@$ser->costo_total-@$ser->adelanto)}}</td>
                    @else
                        <td style="font-size:12px;"align="right"><strong>ANTICIPO S/.</strong></td>
            ...
            <table width="100%" CELLPADDING="5">
                <tr>
                    <td width="100%" class="celdaRoja" style="font-size:medium;color:#002699;"align="center"><strong>OBSERVACIONES</strong></td>
                </tr>
                <tr>
                    <td width="100%"  style="font-size:12px"align="center">{{$ser->text}}</td>
                </tr>
            </table>
            <table width="100%" >
                @for ($i = 1; $i <=50; $i++)
            ...
            <table width="100%">
                <tr>
                    <td align="center" style="font-size:12px;" width="100%"><strong>En caso de no recoger, por servicio o cotización de su turbo el taller no se hace responsable por pérdida o deterioro pasados los 30 días</strong></td>
                </tr>
            </table>
        </main>
    </body>
